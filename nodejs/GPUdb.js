...
GPUdb.prototype.visualize_isochrone = function(graph_name, weights_on_edges, source_node, restrictions, max_solution_radius, num_levels, generate_image, projection, image_width, image_height, style_options, solve_options, contour_options, options, callback) {
    if (callback === undefined || callback === null) {
        ...
        return new Promise( function( resolve, reject) {
            self.visualize_isochrone(graph_name, weights_on_edges, source_node, restrictions, max_solution_radius, num_levels, generate_image, projection, image_width, image_height, style_options, solve_options, contour_options, options, function(err, response) {
                if (err !== null) {
                    reject(err);
                } else {
                    resolve( response );
